        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <article 
                key={index} 
                className="bg-white hover:-top-3 top-0 relative transition-all cursor-pointer duration-300 rounded-2xl overflow-hidden shadow-lg"
              >
                  ...
                  <div className="flex flex-col gap-4">
                    {course.options.map((option, optIndex) => (
                      <div key={optIndex} className="flex justify-between items-center">
                        ...
                        <button className="bg-gray-100 text-gray-900 cursor-pointer px-6 py-3 rounded-xl font-medium text-sm hover:bg-primary hover:text-white transition-colors">
                          {option.duration}
                        </button>
                      </div>
                    ))}
